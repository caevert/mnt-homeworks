...
6. Добавьте новый тег на коммит с рабочим сценарием в соответствии с семантическим версионированием.
    ...
    [Vector-role release v0.2](https://github.com/Muroway/vector-role/releases/tag/v0.2).
...
py37-ansible210 run-test-pre: PYTHONHASHSEED='2926362776'
py37-ansible210 run-test: commands[0] | molecule test -s compatibility --destroy always
...
__________________________________________________________summary _________________________________________________________________________________________
...
8. Запустите команду `tox`. Убедитесь, что всё отработало успешно.
    ...
    [Вывод команды tox](./playbook/vector-role/tox_out.txt).


9. Добавьте новый тег на коммит с рабочим сценарием в соответствии с семантическим версионированием.

    [Vector-role release v0.4: лобавлена проверка tox](https://github.com/Muroway/vector-role/releases/tag/v0.4).
